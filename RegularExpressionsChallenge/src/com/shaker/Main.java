...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String challenge5 = "aaabcccccccccddddeffffg";
        System.out.println(challenge5.matches("[abcdefg]+"));
        System.out.println(challenge5.matches("[a-g]+"));

        System.out.println(challenge5.matches("^a{3}bc{9}d{4}ef{4}g$"));
        System.out.println(challenge5.replaceAll("^a{3}bc{9}d{4}ef{4}g$", "REPLACED"));
        ...
        System.out.println("*******************************************");
        String challenge11a = "{0, 2}, {0, 5}, {1, 3}, {2, 4} {z, y}, {6, 9}, {11, 12}";
        ...
        String challemg12 = "11111";
        System.out.println(challemg12.matches("^\\d{5}$"));

        String challenge13 = "11111-1111";
        System.out.println(challenge13.matches("^\\d{5}-\\d{4}$"));

        System.out.println(challemg12.matches("^\\d{5}(-\\d{4})?$"));
        System.out.println(challenge13.matches("^\\d{5}(-\\d{4})?$"));
